...
using WebApiDowntime.Models.spslogger;

namespace WebApiDowntime.Context.spslogger;
...
//        => optionsBuilder.UseMySql("server=192.168.100.24;database=spslogger;port=3306;uid=user_2;pwd=2011200420112004", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.45-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Mixreport>(entity =>
        {
            ...
            entity.Property(e => e.Data254).HasColumnName("Data_254");
            entity.Property(e => e.Data255).HasColumnName("Data_255");
            entity.Property(e => e.Data256).HasColumnName("Data_256");
