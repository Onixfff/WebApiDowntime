...
public partial class Zugang
{
    public uint Dbid { get; set; }

    public DateTime Timestamp { get; set; }

    public double? Data61 { get; set; }

    public double? Data62 { get; set; }

    public int? Data135 { get; set; }
